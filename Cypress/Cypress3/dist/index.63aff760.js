...
})({"eFATL":[function(require,module,exports,__globalThis) {
...
function getUserLocation(event) {
    ...
    } else displayInfoMessage('Your browser or permission settings do not allow location fetching.');
}
...
function copyToClipboard(data, infoText) {
    if ('clipboard' in navigator) navigator.clipboard.writeText(data).then(function() {
...
},{}]},["eFATL","adjPd"], "adjPd", "parcelRequire94c2")
